...
<head>
	...
	<title>Mostrando ideias com a tag <?=$tag;?> Thinkhub.com</title>
 ...
 <!-- Project One -->
      <div class="row">
        <div class="col-md-12">
          ...
          <p>
		  <?php
		  if(null !== $postsingle['image'] && $postsingle['image'] != "" && file_exists("uploads/" . $postsingle['image'])){
			  echo "<img src='uploads/" . $postsingle['image'] . "' 
			  style='display:block; max-width:400px; width:100%;'/>";
		  }
		 $string = $postsingle['idea'];
		 ...
		 ?>
		  ...
		  <a class="" href="idea?id=<?=$postsingle['post_id']; ?>"><i class="fa fa-plus"></i> Ler mais</a>
		  <?php 
